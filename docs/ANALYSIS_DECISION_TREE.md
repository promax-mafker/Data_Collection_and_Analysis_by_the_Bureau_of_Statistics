...
> **代码化状态:M8 已将本树实现为可执行引擎 `app/analysis/decision_tree.py`(`tree_audit`,T0-T5 共 18 节点裁决),集成到 Kami 经济画像报告第五章「方法论体检」、`quanzhou.py --tree` CLI 与 `/api/quanzhou/tree`;同时顺带修复消费/出口/债务取数的同年错位(A10)。详见 `docs/DESIGN_M8_DECISION_TREE.md` 与 PROGRESS §4.8。**
